                ...
                <div className='flex items-center space-x-2'>
                  <div className='text-xl font-semibold text-green-700 font-serif'>
                    ...
                    <span className='text-green 700 ml-1'>
                       <svg className="w-4 h-4 inline-block align-top" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" className="text-green-500"/> 
                   </svg>
                    </span>
                  </div>
                </div>
